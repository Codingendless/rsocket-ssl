...
@Profile("client")
@Configuration
@EnableConfigurationProperties(RSocketSslClientProperties.class)
public class RSocketSslClientConfigure {

    @Bean
    public RSocketRequester rsocketRequester(
            RSocketSslClientProperties properties, RSocketStrategies rsocketStrategies) {
